...
public class AtivarQuestao extends JFrame {
	...
	public AtivarQuestao() {
		...
		btnAtivar.setBounds(738, 469, 89, 23);
	...
	//	contentPane.add(apagar);
		...
		try {
			...
			for (Questao c : dao.todasQuestoesInativas()) {
				modelo.addRow(
